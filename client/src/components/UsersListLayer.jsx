                            ...
                            {users.map((user, index) => (
                                <tr key={user._id}>
                                    ...
                                    <td className="text-center">
                                        <span className={`px-24 py-4 radius-4 fw-medium text-sm ${user.isActive ? 'bg-success-focus text-success-600 border border-success-main' : 'bg-neutral-200 text-neutral-600 border border-neutral-400'}`}>
